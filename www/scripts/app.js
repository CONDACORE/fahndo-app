  ...
  'errorLocationMissingText'])
    .then(function (translations) {
      ...
      $scope.distances = [
		...
		{ val: 200.00, text: '200 ' + $scope.storage.unit },
        { val: 1200.00, text: 'Alle anzeigen (Standart)' },
      ];
    });
...
.controller('PlaceDetailCtrl', function ($scope, $rootScope, $stateParams, $ionicLoading,
  ...
  $scope.openiOSMaps = function (lat, lng) {
...
.constant('Config', {
  ...
  ENV: {
    ...
    'push': {
      'appId': '3E956-F14F1',
      'googleProjectNumber': 'A1035724363491'
    },
    'admob': {
